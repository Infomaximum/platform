...
/**
 * Тесты {@link StringUtils}, прежде всего лимитированной сериализации
 * {@link StringUtils#toLimitedJsonString(JSONObject, int)} — защиты от краха узла
 * при сериализации чрезмерно большого GraphQL-ответа (PT-16958).
 */
